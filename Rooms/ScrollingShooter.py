...
class ScrollingShooter(Level):
    def __init__(self, screen):
        Level.__init__(self, screen)

        # - Set Background image - #
        self.set_background_image(pygame.image.load("Images/ocean.jpg"))
        ...
        # Load Sounds
        self.fire_bullet_sound = self.load_sound("Sounds/fire_bullet.wav")
        self.explosion_sound = self.load_sound("Sounds/explosion.wav")
